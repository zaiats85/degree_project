...
#### `for rent Owners:` 
- guaranteed items return (without [national pass, driving license] pledge** )
- shared clients rating access 
- oneClick financial reporting 
- inventory metrics
...
*Nearby villages Yablunutsa, Tatariv, Mykyluchun inclusive  
** Or Foreigner Travel Pass. 
...
Дипломна робота, на тему "Організація мережі пунктів прокату гірськолижного спорядження"
...
#### `для відпочиваючих:`
- ринкові (не спекулятивні) ціни на спорядження
- попереднє замовлення онлайн, оплата
- моніторинг наявності інвентаря
- відгуки, cкарги та заохочення, обговорення, cитуативні чати, допомога

#### `для власників пунктів прокату:` 
- гарантія повернення спорядження (без застави - паспорту громадянина** України),
...
### `критика або проект не відбудеться`
- небажання власників співпрацювати
- небажання операторів прокатів вносити дані в систему
- за відсутності команди (розробники, менеджер)
- за відсутності грошей на розробку. 
